...
- (void)viewDidLoad
{
    ...
    borderView.image = DSZQRImageName(@"pick_bg");
    
    borderView.frame=CGRectMake(scanner_X, scanner_Y, SCANNER_WIDTH, SCANNER_WIDTH);
    [self.view addSubview:borderView];
    //扫描线
    self.lineView=[[UIImageView alloc]init];
    
    self.lineView.image =DSZQRImageName(@"line");
