...
typedef enum {
	/** No error. */
	BWTSSKeychainErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
	BWTSSKeychainErrorBadArguments = -1001,
	
	/** There was no password. */
	BWTSSKeychainErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
	BWTSSKeychainErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
	BWTSSKeychainErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
	BWTSSKeychainErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
	BWTSSKeychainErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
	BWTSSKeychainErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
	BWTSSKeychainErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
	BWTSSKeychainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
	BWTSSKeychainErrorFailedToDecode = errSecDecode
} BWTSSKeychainErrorCode;

extern NSString *const kBWTSSKeychainErrorDomain;

/** Account name. */
extern NSString *const kBWTSSKeychainAccountKey;
 ...
 */
extern NSString *const kBWTSSKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kBWTSSKeychainClassKey;

/** Item description. */
extern NSString *const kBWTSSKeychainDescriptionKey;

/** Item label. */
extern NSString *const kBWTSSKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kBWTSSKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kBWTSSKeychainWhereKey;
...
/**
 ...
 BWTSSKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface BWTSSKeychain : NSObject
...
/**
 ...
 See the `NSString` constants declared in BWTSSKeychain.h for a list of keys that can be used when accessing the
