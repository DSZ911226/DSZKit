...
typedef enum {
	/** No error. */
	DSZSSKeychainErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
	DSZSSKeychainErrorBadArguments = -1001,
	
	/** There was no password. */
	DSZSSKeychainErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
	DSZSSKeychainErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
	DSZSSKeychainErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
	DSZSSKeychainErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
	DSZSSKeychainErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
	DSZSSKeychainErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
	DSZSSKeychainErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
	DSZSSKeychainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
	DSZSSKeychainErrorFailedToDecode = errSecDecode
} DSZSSKeychainErrorCode;

extern NSString *const kDSZSSKeychainErrorDomain;

/** Account name. */
extern NSString *const kDSZSSKeychainAccountKey;
 ...
 */
extern NSString *const kDSZSSKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kDSZSSKeychainClassKey;

/** Item description. */
extern NSString *const kDSZSSKeychainDescriptionKey;

/** Item label. */
extern NSString *const kDSZSSKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kDSZSSKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kDSZSSKeychainWhereKey;
...
/**
 ...
 DSZSSKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface DSZSSKeychain : NSObject
...
/**
 ...
 See the `NSString` constants declared in DSZSSKeychain.h for a list of keys that can be used when accessing the
