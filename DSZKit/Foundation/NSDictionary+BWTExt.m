...
#import "NSDictionary+BWTExt.h"
#import "NSString+BWTExt.h"

@interface _BWTXMLDictionaryParser : NSObject <NSXMLParserDelegate>
@end

@implementation _BWTXMLDictionaryParser {
...
@implementation NSDictionary (BWTExt) 
...
+ (NSDictionary *)dictionaryWithXML:(id)xml {
    _BWTXMLDictionaryParser *parser = nil;
    if ([xml isKindOfClass:[NSString class]]) {
        parser = [[_BWTXMLDictionaryParser alloc] initWithString:xml];
    } else if ([xml isKindOfClass:[NSData class]]) {
        parser = [[_BWTXMLDictionaryParser alloc] initWithData:xml];
    }
...
@implementation NSMutableDictionary (BWTExt)
