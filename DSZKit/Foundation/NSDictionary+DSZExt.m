...
#import "NSDictionary+DSZExt.h"
#import "NSString+DSZExt.h"

@interface _DSZXMLDictionaryParser : NSObject <NSXMLParserDelegate>
@end

@implementation _DSZXMLDictionaryParser {
...
@implementation NSDictionary (DSZExt) 
...
+ (NSDictionary *)dictionaryWithXML:(id)xml {
    _DSZXMLDictionaryParser *parser = nil;
    if ([xml isKindOfClass:[NSString class]]) {
        parser = [[_DSZXMLDictionaryParser alloc] initWithString:xml];
    } else if ([xml isKindOfClass:[NSData class]]) {
        parser = [[_DSZXMLDictionaryParser alloc] initWithData:xml];
    }
...
@implementation NSMutableDictionary (DSZExt)
