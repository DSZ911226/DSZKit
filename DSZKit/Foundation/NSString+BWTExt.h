 ...
 * 网络签名方法，服务端共用参数使用
 */
+ (NSString *)sign:(NSDictionary *)params BWTDEPRECATED(1_13);


/**
 * 最新协议的网络签名方法，服务端共用参数使用
 */
+ (NSString *)newSign:(NSString *)params BWTDEPRECATED(1_13);


/**
 * RSA解密
 */
+ (NSString *)decryptString:(NSString *)signature BWTDEPRECATED(1_13);

/**
 * 随机批次号，有当前时间，服务端共用参数使用
 当前方法已经废弃, 请使用BWTNetTools sequence方法
 */
+ (NSString *)sequence BWTDEPRECATED(1_13);
 ...
 * 加密字段，服务端共用参数使用
 */
+ (NSString *)encryptRandom:(NSString *)value BWTDEPRECATED(1_13);
