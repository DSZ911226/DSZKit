...
@implementation NSData (DSZBase64)
...
+ (NSData *)dataFromBase64String:(NSString *)aString
{
    ...
    size_t outputLength;
    void *outputBuffer = DSZNewBase64Decode([data bytes], [data length], &outputLength);
...
- (NSString *)base64EncodedString
{
    ...
    char *outputBuffer =
        DSZNewBase64Encode([self bytes], [self length], false, &outputLength);
