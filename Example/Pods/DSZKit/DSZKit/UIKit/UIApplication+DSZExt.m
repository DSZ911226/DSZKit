...
- (BOOL)isPirated {
    ...
    if (![self _DSZ_fileExistInMainBundle:@"_CodeSignature"]) {
        return YES;
    }
    
    if (![self _DSZ_fileExistInMainBundle:@"CodeResources"]) {
        return YES;
    }
    
    if (![self _DSZ_fileExistInMainBundle:@"ResourceRules.plist"]) {
        return YES;
    }
...
- (BOOL)_DSZ_fileExistInMainBundle:(NSString *)name {
